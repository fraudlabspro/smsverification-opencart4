...
class Fraudlabsprosmsverification extends \Opencart\System\Engine\Controller {
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/fraudlabsprosmsverification/fraud/fraudlabsprosmsverification', 'user_token=' . $this->session->data['user_token'], true)
		];
		...
		$data['save'] = $this->url->link('extension/fraudlabsprosmsverification/fraud/fraudlabsprosmsverification|save', 'user_token=' . $this->session->data['user_token'], true);
